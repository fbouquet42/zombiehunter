...
def mainmenu(env, clock):
    ...
    while True:
        ...
        if env.pressed[pygame.K_SPACE] or env.pressed[pygame.K_r]:
            break
    ...
    player_one.selected(env, title_player_one, (pygame.K_w, pygame.K_a, pygame.K_s, pygame.K_d, pygame.K_r), x1, y)
    player_two.selected(env, title_player_two, (pygame.K_UP, pygame.K_LEFT, pygame.K_DOWN, pygame.K_RIGHT, pygame.K_SPACE), x2, y)
