...
class Vampire(DefaultMonster):
    ...
    def build_class(cls):
        ...
        cls.img_bat = cls.tools.set_imgs(cls.env.img_folder + 'monsters/', 'bat', cls.dimensions)
        cls.img_bat_injured = cls.tools.set_imgs(cls.env.img_folder + 'monsters/', 'bat' + '_injured', cls.dimensions)
        return cls
